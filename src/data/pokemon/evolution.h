...
{
    [SPECIES_SATIGRA]             = {{EVO_LEVEL, 16, SPECIES_GRADACEA}},
    [SPECIES_GRADACEA]               = {{EVO_LEVEL, 32, SPECIES_HERBAREM}},
    [SPECIES_HERBAREM]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA}},
    [SPECIES_MOBBURN]            = {{EVO_LEVEL, 16, SPECIES_CONFLEECE}},
    [SPECIES_CONFLEECE]            = {{EVO_LEVEL, 36, SPECIES_ENLIGHDER}},
    [SPECIES_ENLIGHDER]             = {{EVO_MEGA_EVOLUTION, ITEM_CHARIZARDITE_X, SPECIES_CHARIZARD_MEGA_X},
    ...
    [SPECIES_WIRLIXPLOR]             = {{EVO_MEGA_EVOLUTION, ITEM_BLASTOISINITE, SPECIES_BLASTOISE_MEGA}},
    [SPECIES_BULBITE]              = {{EVO_LEVEL, 20, SPECIES_LAMPUPA}},
    [SPECIES_LAMPUPA]                = {{EVO_LEVEL, 35, SPECIES_LUMINOTH}},
    [SPECIES_LUMINOTH]              = {{EVO_MEGA_EVOLUTION, ITEM_BEEDRILLITE, SPECIES_BEEDRILL_MEGA}},
    [SPECIES_EUPHOLIDAE]              = {{EVO_LEVEL, 21, SPECIES_MLADIBUG}},
    [SPECIES_INCOGNICROW]                = {{EVO_LEVEL, 18, SPECIES_SUSPECK}},
    [SPECIES_SUSPECK]             = {{EVO_LEVEL, 40, SPECIES_CYBIRB}},
    [SPECIES_CYBIRB]               = {{EVO_MEGA_EVOLUTION, ITEM_PIDGEOTITE, SPECIES_PIDGEOT_MEGA}},
