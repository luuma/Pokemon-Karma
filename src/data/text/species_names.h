const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_SATIGRA] = _("Satigra"),
    [SPECIES_GRADACIA] = _("Gradacia"),
    [SPECIES_HERBAREM] = _("Herbarem"),
    [SPECIES_MOBBURN] = _("Mobburn"),
    [SPECIES_CONFLEECE] = _("Confleece"),
    [SPECIES_ENLIGHDER] = _("Enlighder"),
    [SPECIES_FOMPOUS] = _("Fompous"),
    [SPECIES_ASTROHAUT] = _("Astrohaut"),
    [SPECIES_WIRLIXPLOR] = _("Wirlixplor"),
    [SPECIES_BULBITE] = _("Bulbite"),
    [SPECIES_LAMPUPA] = _("Lampupa"),
    [SPECIES_LUMINOTH] = _("Luminoth"),
    [SPECIES_SKELIPEDE] = _("Skelipede"),
    [SPECIES_COFFINSECT] = _("Coffinsect"),
    [SPECIES_EUPHOLIDAE] = _("Eupholidae"),
    [SPECIES_MLADIBUG] = _("M'ladibug"),
    [SPECIES_SNAGOON] = _("Snagoon"),
    [SPECIES_REPOCOON] = _("Repocoon"),
